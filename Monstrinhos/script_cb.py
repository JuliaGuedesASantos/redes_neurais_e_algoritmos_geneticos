...
def funcao_objetivo_cb(candidato):
    """Calcula a função objetivo para as resoluções por busca aleatória e busca em grade"""
...
###############################################################################
def gene_cb_rs():
    """Cria um gene - ou seja, uma caixa - para a resolução do problema das caixas binárias"""
    valores_possiveis = [0, 1]
    gene = random.choice(valores_possiveis)
    return gene

def cria_candidato_cb_rs(n):
    """Cria um conjunto n de caixas
